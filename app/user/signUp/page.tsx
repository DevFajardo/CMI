...
export default function userSignUp() {
    ...
    const areFieldsNotEmpty = fields.name !== "" && fields.lastName !== "" && fields.email !== "" && fields.password !== "" && fields.repeatpassword !== "";
    return (
        <div>
            <form className="animate-in flex-1 flex flex-col w-full justify-center gap-2 text-foreground">
                <label htmlFor="name" className="text-md">Nombre</label>
                <input type="text" name="name" placeholder="nombre completo" value={fields.name} onChange={handleFieldChange} />
